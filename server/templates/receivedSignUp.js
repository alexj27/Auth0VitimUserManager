            ...
            <div style="display: flex; flex-direction:column;align-items: center;">
                ...
                <div style="width: 100%; padding: 15px; background-color: white; border-radius: 4px;">
                    <div style="padding: 10px 15px;">
                        Hello, <br />\
                        <a class="button" href='${ params.resetUrl }' target='_blank'
                    ...
                    <div style="padding: 10px 15px;">
                        If you are having any issues with your account, please don't hesitate to contact us by this email 
                        <a href="mailto:${ params.support }">${ params.support }</a>.
                    </div>
